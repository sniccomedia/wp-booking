var bookly = (function ($) {
	...
	*/
	...
	var find_1 = function (it) {
	  var own = it.find;
	  return it === ArrayPrototype$b || (it instanceof Array && own === ArrayPrototype$b.find) ? find$2 : own;
	};
	...
	var splice_1 = function (it) {
	  var own = it.splice;
	  return it === ArrayPrototype$a || (it instanceof Array && own === ArrayPrototype$a.splice) ? splice$2 : own;
	};
	...
	function stepDetails(params) {
	      ...
	      if (response.success) {
	        ...
	        var populateForm = function populateForm(response) {
	          ...
	          if (response.data.info_fields) {
	            ...
	            forEach$1(_context3 = response.data.info_fields).call(_context3, function (field) {
	              ...
	              switch ($info_field.data('type')) {
	                case 'checkboxes':
	                  forEach$1(_context4 = field.value).call(_context4, function (value) {
	                    var _context5;
	        ...
	        $modals.addClass(params.form_id).appendTo($container).on('click', '.bookly-js-close', function (e) {
	          ...
	          find(_context7 = find(_context8 = find(_context9 = $__default['default'](e.delegateTarget).removeClass('bookly-in')).call(_context9, 'form').trigger('reset').end()).call(_context8, 'input').removeClass('bookly-error').end()).call(_context7, '.bookly-label-error').html('');
	        }); // Login modal.
	            ...
	            success: function success(response) {
	              ...
	              if (response.success) {
	                ...
	                if (response.appointments_limit_reached) {
	                  ...
	                  forEach$1(validateFields).call(validateFields, function (field) {
	        ...
	        $__default['default']('.bookly-js-back-step', $container).on('click', function (e) {
	          ...
	          } else if (!repeat(opt[params.form_id].skip_steps)) {
	            stepRepeat({
	              form_id: params.form_id
	            });
	  ...
	  function initGooglePlacesAutocomplete($container) {
	    ...
	    autocomplete.addListener('place_changed', function () {
	      forEach$1(autocompleteFields).call(autocompleteFields, function (field) {
	        ...
	        if (response.success) {
	          ...
	          if (response.repeated) {
	            ...
	            switch (repeat(repeat_data)) {
	              ...
	              case 'biweekly':
	                ...
	                forEach$1(_context3 = repeat_params.on).call(_context3, function (val) {
	          ...
	          $__default['default']('.bookly-js-next-step', $container).on('click', function (e) {
	            ...
	            if ($repeat_enabled.is(':checked')) {
	              ...
	              forEach$1(schedule).call(schedule, function (item) {
	                if (!item.deleted) {
	...
	function createEventDispatcher() {
	  ...
	  return function (type, detail) {
	    ...
	    if (callbacks) {
	      ...
	      forEach$1(_context12 = slice$3(callbacks).call(callbacks)).call(_context12, function (fn) {
	...
	function update($$) {
	  if ($$.fragment !== null) {
	    ...
	    forEach$1(_context14 = $$.after_update).call(_context14, add_render_callback);
	  }
	}
	...
	function mount_component(component, target, anchor, customElement) {
	  ...
	  forEach$1(after_update).call(after_update, add_render_callback);
	}
	...
	function init(component, options, instance, create_fragment, not_equal, props) {
	  ...
	  if (options.target) {
	    if (options.hydrate) {
	      ...
	      forEach$1(nodes).call(nodes, detach);
	    } else {
